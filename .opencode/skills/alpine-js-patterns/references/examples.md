...
* [plugins.md](https://agentskill.sh/@majiayu000/references/plugins.md) - Alpine.js plugins (Mask, Intersect, Persist, etc.)
* [patterns.md](https://agentskill.sh/@majiayu000/references/patterns.md) - Common patterns and best practices
